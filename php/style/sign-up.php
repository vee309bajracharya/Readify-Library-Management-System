  ...
  <section class="signup__wrapper">
    <div class="signup__container ">
      ...
      <div class="signup__content__left">
          ...
          <form action="" method="POST">
            <div class="signup__form__container">
              ...
              <div class="fields">
                ...
                <input type="tel" id="phone" name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="+977" required>
              </div>
        ...
        <div class="links">By signing up you have agreed to our <a href="./terms-and-conditions.html">Terms and
            Conditions</a> along with <a href="./privacy-policy.html">Privacy Policy</a>
