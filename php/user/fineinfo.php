...
if (isset($_SESSION['user'])) {
    ...
    $query2 = "SELECT sum(fine) as total_fine FROM fine WHERE username ='$_SESSION[user]' AND book_status ='$exp' AND fine > 0";
...
// Query to fetch fines from the fine table
$query4 = "SELECT sum(fine) as total_fine FROM fine WHERE username ='$_SESSION[user]' AND book_status ='$lost'";
